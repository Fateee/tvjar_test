	...
	public void init(Context context) {
		...
		try {
			playerConfig = new JSONObject("{\n" +
					"    \"aliyunline2\":{\n" +
					"        \"sh\":\"BD2\",\n" +
					"        \"pu\":\"https://p2.cfnode1.xyz/ty2.php?url=\",\n" +
					"        \"sn\":1,\n" +
					"        \"or\":999\n" +
					"    },\n" +
					"    \"ali\":{\n" +
					"        \"sh\":\"AI\",\n" +
					"        \"pu\":\"https://p.cfnode1.xyz/ai.php?url=\",\n" +
					"        \"sn\":1,\n" +
					"        \"or\":999\n" +
					"    },\n" +
					"    \"LINE406\":{\n" +
					"        \"sh\":\"LINE406\",\n" +
					"        \"pu\":\"https://play.shtpin.com/xplay/?url=\",\n" +
					"        \"sn\":1,\n" +
					"        \"or\":999\n" +
					"    },\n" +
					"    \"LINE405\":{\n" +
					"        \"sh\":\"HD\",\n" +
					"        \"pu\":\"https://p2.cfnode1.xyz/lb.php?url=\",\n" +
					"        \"sn\":1,\n" +
					"        \"or\":999\n" +
					"    },\n" +
					"    \"LINE408\":{\n" +
					...
					"    \"LINE400\":{\n" +
					"        \"sh\":\"LINE400\",\n" +
					"        \"pu\":\"https://p.cfnode1.xyz/lb.php?url=\",\n" +
					"        \"sn\":1,\n" +
					"        \"or\":999\n" +
					"    },\n" +
					"    \"duoduozy\":{\n" +
